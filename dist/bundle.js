 ...
 */
function contrastColors (basecolor, ...colors) {
 ...
 * @param {boolean}  [useCapture] http://qiita.com/hosomichi/items/49500fea5fdf43f59c58
 */
function eventRegister (el, onoff, eventNames, callback, useCapture) {
...
function mousePosition (options) {
  ...
  const position = new PositionManager$1(options);
...
function hitChecker$1 (rect1, rect2, tolerance) {
...
riot$1.tag2('color-wheel', '<div class="color-wheel" riot-style="width: {opts.size}px; height: {opts.size}px;"> <canvas class="color-wheel-canvas" ref="canvas" width="{size}" height="{size}"></canvas> <button class="color-wheel-center" riot-style="{centerDiameter} background-color: {color}; color:{textColor};" onclick="{centerClick}"> <div class="color-wheel-text {active: mode == \'hue\'}">{color.h}</div> <div class="color-wheel-text {active: mode == \'saturation\'}">{color.s}%</div> <div class="color-wheel-text {active: mode == \'lightness\'}">{color.l}%</div> </button> <div each="{btns}" class="color-wheel-btn color-wheel-{className}" ref="{className}" riot-style="{style} color:{textColor}; border-color:{color2}; background-color:{color};" onclick="{click}"> <div class="color-wheel-text">{text}</div> </div> <div class="color-wheel-handle" ref="handle"></div> </div>', '.color-wheel { position: relative; padding: 5px; text-align: center; } .color-wheel-handle { position: absolute; width: 10px; height: 10px; top: 0; left: 0; border: 1px solid black; border-radius: 5px; text-align: left; pointer-events: none; } .color-wheel-handle::before { content: \'\'; position: absolute; width: 8px; height: 8px; border: 1px solid white; border-radius: 4px; } .color-wheel-btn { position: absolute; border-width: 1px; border-style: solid; text-align:center; opacity: 0.6; } .color-wheel-center { position: absolute; top: 0; right: 0; bottom: 0; left: 0; margin: auto; } .color-wheel-text { user-select: none; -ms-user-select: none; -webkit-user-select: none; -moz-user-select: none; pointer-events: none; opacity: 0.8; } .color-wheel-text.active, .color-wheel-btn.active, .color-wheel-btn.active .color-wheel-text, .color-wheel-btn:hover { font-weight: bold; opacity: 1; }', '', function(opts) {
